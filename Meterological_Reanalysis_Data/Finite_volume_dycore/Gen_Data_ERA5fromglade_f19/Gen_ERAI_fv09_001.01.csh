...
#
#SBATCH -J Gen_ERA5_fv19_36L_002.orig 
#SBATCH -n 1
#SBATCH -c 8
#SBATCH --mem=20000
#SBATCH --ntasks-per-node=1
#SBATCH -t 1:00:00
#SBATCH -p sapphire,huce_cascade,shared
#SBATCH -e Log.Gen_ERA5_fv19_36L_002.orig.err.%J
#SBATCH -o Log.Gen_ERA5_fv19_36L_002.orig.err.%J
...
mkdir './LOG/'$RUNNUM'/'
mkdir './TMP/'$RUNNUM'/'
set MYLOGDIR  = './LOG/'$RUNNUM'/'
set MYTMPDIR  = './TMP/'$RUNNUM'/'

set MYOUTDIR  = '/n/home04/sweidman/holylfs04/ERA5/ERA5_f19/'
set INPUTDIR  = '/n/home04/sweidman/holylfs04/for_globus/'
...
#---------------------------------------------------------
set fname_grid_info        = '/n/holystore01/INTERNAL_REPOS/CLIMATE_MODELS/cesm_2_1/inputdata/atm/cam/inic/fv/cami_0000-01-01_1.9x2.5_L26_c070408.nc'
set fname_phis_output        = '/n/holystore01/INTERNAL_REPOS/CLIMATE_MODELS/cesm_2_1/inputdata/atm/cam/topo/USGS-gtopo30_1.9x2.5_remap_c050602.nc'
...
set fname[1] = "ERA5_e5.oper.ml.v3.uvtqps.YYYYMMDDHH.nc"
set ftype[1] = "ERA5"
set ftime[1] = "1X"
#set fname[2] = "ERA5_e5.oper.ml.v3.ps.YYYYMMDDHH.nc"
#set ftype[2] = "ERA5"
#set ftime[2] = "1X"
...
while ( $NDAYS < $NUM_DAYS )
  ...
  if ($Monstr == "02" && $Daystr == "29") then
    echo "Leap year, continuing"
    @ NDAYS = $NDAYS + 1
    @ NUM_DAYS = $NUM_DAYS + 1 
    continue
  endif
