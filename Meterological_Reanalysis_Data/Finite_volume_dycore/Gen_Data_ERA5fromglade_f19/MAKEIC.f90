...
!
      do j = 1, plat
         do i = 1,plon
            if(sst(i,j) .gt. 340. .or. sst(i,j) .lt. 150.) then
...
! NCLFORTSTART
      subroutine read_namelist1(NAMENUMBER,I_MYTMPDIR,I_MYOUTDIR,I_INPUTDIR, I_TMP_clean, &
...
! NCLFORTSTART
      subroutine read_namelist2(NAMENUMBER,I_fname_phis_input,I_ftype_phis_input,     &
